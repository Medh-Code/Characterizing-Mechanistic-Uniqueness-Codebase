...
The circuit enumeration procedure we used in our code was largely derived from the codebase of the paper, Everything, Everywhere, All at Once: Is Mechanistic Interpretability Identifiable?. The paper is available here [Paper](https://arxiv.org/abs/2502.20914) and the corresponding codebase can be found here [Github]([https://github.com/ArthurConmy/Automatic-Circuit-Discovery/blob/main/README.md](https://github.com/MelouxM/MI-identifiability)).
